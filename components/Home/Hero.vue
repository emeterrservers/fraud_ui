<template>
  <div class="bg-gradient-to-b from-[#101212] relative to-[#08201D]">
    <section class="relative h-screen pt-24 pb-10 sm:pt-32 sm:pb-16">
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
        <div class="max-w-xl mx-auto text-center">
          <h1 class="text-4xl font-bold sm:text-6xl">
            <span
              class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"
            >
              Fraud Detection System
            </span>
          </h1>
          <p class="mt-5 text-base text-white sm:text-xl">
            Detection Model for prediction of fardulent transaction.
          </p>

          <a
            @click="get_started = !get_started"
            title=""
          ...
          >
            <div class="flex items-center">
              ...
              <p class="ml-3 text-sm text-white">Api Documentation</p>
            </div>
            ...
            <div class="flex items-center">
              ...
              <p class="ml-3 text-sm text-white">Fraud Checker</p>
            </div>
            ...
            <div class="flex items-center">
              ...
              <p class="ml-3 text-sm text-white">Transaction Upload Scanner</p>
            </div>
          </div>
        </div>
      </div>
    </section>
    <q-dialog v-model="get_started">
      <q-card>
        <q-card-section>
          <div class="text-h6">
            Get Started by selecting one of the following
          </div>
        </q-card-section>

        <q-card-section class="q-pt-none">
          <div
            class="w-full mt-5 flex gap-3 flex-col justify-center items-center"
          >
            <q-btn :to="{path: '/api_docs'}" class="w-full py-2 rounded-md" color="green">
              Api Documentation Usage
            </q-btn>
            <q-btn  :to="{path: '/fraud_checker'}" class="w-full py-2 rounded-md" color="blue">
              Fraud Checker Page
            </q-btn>

            <q-btn :to="{path: '/file_upload'}" class="w-full py-2 rounded-md" color="pink">
              Transaction Upload Scanner
            </q-btn>
          </div>
        </q-card-section>
      </q-card>

<template>
  ...
  <div class="w-full h-screen flex flex-col items-center justify-between">
    <div
      class="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0"
    >
      <svg
        class="w-3/4"
      ...
      <p class="text-xl text-gray-700 uppercase mt-4">We'll be back soon</p>
        ...
        <p class="text-xl text-gray-700 uppercase mt-4">Upgrading to Version 2.0 </p>
    </div>
    <div class="w-full py-4 border-t border-gray-300">
      <div
        class="mx-auto flex flex-col md:flex-row items-center justify-center text-gray-600 text-sm md:space-x-8 space-y-1 md:space-y-0"
      >
        ...
        >
          ...
          <span>support@xprintxchang.com</span>
        </a>
      </div>
    </div>
  </div>

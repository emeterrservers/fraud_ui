    ...
    async GetNetworks() {
      try {
        ...
        const res = await axios.get(
          `/api/admin/services?id=${userCred.uid}&service=CABLESPLAN`,
          {
            headers: {
    ...
    async SaveChanges() {
      try {
        ...
        const res = await axios.post(
          `/api/admin/services?id=${userCred.uid}&services=CABLESPLAN`,
          this.dform,
          {
            headers: {
              Accept: "application/json",

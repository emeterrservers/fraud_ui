    ...
    async GetNetworks() {
      try {
        ...
        const res = await axios.get(
          `/api/admin/services?id=${userCred.uid}&service=ATC`,
          {
            headers: {
    ...
    async SaveChanges() {
      try {
        ...
        const res = await axios.post(
          `/api/admin/services?id=${userCred.uid}&services=ATC`,
          this.dform,
          {
            headers: {
              Accept: "application/json",
